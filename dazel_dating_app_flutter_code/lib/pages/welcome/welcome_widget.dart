                          ...
                          children: [
                            Text(
                              FFLocalizations.of(context).getText(
                                'bsf61nxj' /* 🌟 Welcome to the Galaxy of Co... */,
                              ),
                            ...
                            Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'trtdh6b6' /* Get ready to explore new conne... */,
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .labelMedium
                                    .override(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    FlutterFlowIconButton(
                                      ...
                                      onPressed: () async {
                                        logFirebaseEvent(
                                            'WELCOME_navigate_next_rounded_ICN_ON_TAP');
                                        logFirebaseEvent(
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(
                              FFLocalizations.of(context).getText(
                                'nl6evs94' /* Time to meet new people! 🌟 */,
                              ),
                              style: FlutterFlowTheme.of(context)
                                  .headlineMedium
                                  .override(
                            ...
                            Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'dtx3efvh' /* Find interesting profiles and ... */,
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .labelMedium
                                    .override(
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(
                              FFLocalizations.of(context).getText(
                                '586be8vg' /* Start conversations and have f... */,
                              ),
                              style: FlutterFlowTheme.of(context)
                                  .headlineMedium
                                  .override(
                            ...
                            Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  '8ewfeuau' /* Send messages, share laughs, a... */,
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .labelMedium
                                    .override(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    'p30j54yt' /* Create your profile and start ... */,
                                  ),
                              ...
                              Padding(
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    ...
                                    context.pushNamed('MainAuth');
                                  },
                                  text: FFLocalizations.of(context).getText(
                                    '4iohm418' /* Get Started */,
                                  ),
