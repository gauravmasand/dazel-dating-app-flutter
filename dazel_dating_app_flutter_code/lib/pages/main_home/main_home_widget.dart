...
import 'package:dazel_dating_app/pages/main_home/ChatsDisplayPage.dart';
import 'package:dazel_dating_app/pages/main_home/GotLikes.dart';
...
class _MainHomeWidgetState extends State<MainHomeWidget>
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'MainHome'});
    MainHomeModel.tabBarController = TabController(
      vsync: this,
      length: 5,
      initialIndex: 2,
          ...
          body: SafeArea(
            ...
            child: Column(
              children: [
                Expanded(
                  child: TabBarView(
                    controller: MainHomeModel.tabBarController,
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        InkWell(
                                          ...
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'MAIN_HOME_PAGE_Icon_wabahivw_ON_TAP');
                                            logFirebaseEvent(
                                                'Icon_navigate_to');
